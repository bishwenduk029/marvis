...
// its own y.
//
// Adapted from omarchy-omapilot (MIT, spencerbull/omarchy-omapilot): the
// MarkdownView child was replaced with a plain wrapped Text, because the Marvis
// daemon delivers replies as plain strings over the socket, not markdown.
Item {
  id: root
  ...
  PanelWindow {
    ...
    WlrLayershell.namespace: "marvis-curtain"
